<?php
    ...
    $texto = $_GET['texto'] ?? '';
    $rubros = RubroController::listado_ru($texto);
?>
...
<body class="bg-light">
    ...
    <div class="container py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                <a href="crear_rubros.php" class="btn btn-success shadow-sm">
                    <i class="bi bi-plus-circle"></i> Nuevo Rubro
                </a>
                <a href="../../reports/reporte_rubros.php" target="_blank" class="btn btn-primary shadow-sm">
                        ...
                        <tbody>
                            <?php if (!empty($rubros)): ?>
                                <?php foreach ($rubros as $ru): ?>
                                    <tr>
                                        <td><?php echo htmlspecialchars($ru['codigo_ru']); ?></td>
    ...
    <div class="modal fade" id="modalEditar" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form method="POST" action="editar_rubros.php">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="eliminar_rubros.php" id="btnConfirmarEliminar" class="btn btn-danger">
    ...
    <script src="../../assets/rubros.js"></script>
</body>
