...
$texto = $_GET['texto'] ?? '';
$categorias = CategoriaController::listado_ca($texto);
?>
...
<body class="bg-light">
    ...
    <div class="container py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                <a href="crear_categorias.php" class="btn btn-success shadow-sm">
                    <i class="bi bi-plus-circle"></i> Nueva Categoría
                </a>
                <a href="../../reports/reporte_categorias.php" target="_blank" class="btn btn-primary shadow-sm">
                        ...
                        <tbody>
                            <?php if (!empty($categorias)): ?>
                                <?php foreach ($categorias as $ca): ?>
                                    <tr>
                                        <td><?php echo htmlspecialchars($ca['codigo_ca']); ?></td>
    ...
    <div class="modal fade" id="modalEditar" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form method="POST" action="editar_categorias.php">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="eliminar_categorias.php" id="btnConfirmarEliminar" class="btn btn-danger">
    ...
    <script src="../../assets/categorias.js"></script>
</body>
