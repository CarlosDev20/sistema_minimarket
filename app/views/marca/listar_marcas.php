    ...
    <div class="container py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                ...
                <a href="marca/reporte_marcas" target="_blank" class="btn btn-primary shadow-sm">
        ...
        <div class="card shadow-lg rounded">
            <div class="card-header bg-dark text-white d-flex justify-content-between align-items-center">
                ...
                <form class="d-flex" method="GET" action="marca/listar_marcas">
                        ...
                        <tbody>
                            <?php if (!empty($marcas)): ?>
                                <?php foreach ($marcas as $ma): ?>
                                    <tr>
                                        <td class="ps-3"><?php echo htmlspecialchars($ma['codigo_ma']); ?></td>
    ...
    <div class="modal fade" id="modalCrear" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form method="POST" action="marca/guardar">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="descripcion_ma_crear" class="form-label">Descripción</label>
                            <input type="text" class="form-control" id="descripcion_ma_crear" name="descripcion_ma"
                                required>
                        </div>
                    </div>
